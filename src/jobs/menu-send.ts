 ...
 * capture mode (Reader View / Full Page) and apply it as a one-off override on
 * the stored settings. Returns undefined for an unrecognized id so the SW
 * callback stays a pure delegator (guard a). Covered.
 */
